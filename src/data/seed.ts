...
async function main() {
  ...
  const services = [
    ...
    },
    {
      slug: "governance",
      locale: "ar",
      title: "الحوكمةorporate Governance",
      ...
      content: "الحوكمةorporate Governance هي حجر الأساس في نجاح المؤسسات الحديثة. نقدم خدمات تصميم وتطبيق أنظمة الحوكمة المؤسسية بما يتوافق مع أفضل الممارسات العالمية ومتطلبات السوق السعودي.",
      ...
      isPublished: true,
      isFeatured: true,
      metaTitle: "الحوكمةorporate Governance — مكتب الشهراني",
